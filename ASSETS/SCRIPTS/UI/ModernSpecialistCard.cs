...
namespace LocalLLMNPC.UI
{
    ...
    {
        [Signal]
        public delegate void CardSelectedEventHandler(NPCSpecialty specialty);

        [Signal]
        public delegate void CardHoveredEventHandler(NPCSpecialty specialty);
