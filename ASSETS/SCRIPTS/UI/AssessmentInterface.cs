...
namespace LocalLLMNPC.UI
{
    ...
    public partial class AssessmentInterface : Control
    {
        ...
        private void CreateAssessmentHeader()
        {
            ...
            assessmentTitle.Text = "📝 Agricultural Knowledge Assessment";
            ...
            timeRemainingLabel.Text = "⏱️ Time: 25:00";
        ...
        private void CreateDetailsPanel(HBoxContainer parent)
        {
            ...
            detailsLabel.Text = "📊 Assessment Details";
            ...
            confidenceLabel.Text = "🎯 Confidence Level";
        ...
        private void CreateNavigationArea()
        {
            ...
            submitButton.Text = "🎯 Submit Assessment";
            ...
            reviewIndicator.Text = "💡 Tip: Review your answers before submitting";
        ...
        private void CreateResultsArea()
        {
            ...
            resultsHeader.Text = "🎓 Assessment Results";
            ...
            retryButton.Text = "🔄 Retake Assessment";
        ...
        {
            assessmentTitle.Text = $"📝 {GetSpecialtyDisplayName(config.Specialty)} Assessment";

            difficultyLabel.Text = $"🎯 Difficulty: {currentSession.Difficulty}";
            estimatedTimeLabel.Text = $"⏱️ Est. Time: {currentSession.EstimatedDuration.TotalMinutes:F0} minutes";
            topicsLabel.Text = $"📚 Topics: {string.Join(", ", currentSession.Topics.Take(3))}";
        ...
        private void UpdateTimeDisplay()
        {
            ...
            timeRemainingLabel.Text = $"⏱️ Time: {remaining.TotalMinutes:F0}:{remaining.Seconds:D2}";
        ...
        private async void ShowTimeExpiredDialog()
        {
            ...
            dialog.DialogText = "⏰ Time's up! Your assessment will be submitted automatically.";
        ...
        private void ShowPerformanceBreakdown(AssessmentResult result)
        {
            ...
            titleLabel.Text = "📊 Performance Breakdown";
            titleLabel.AddThemeStyleboxOverride("normal", CreateSectionStyle());
            performanceBreakdown.AddChild(titleLabel);

            // Overall score
            var scoreLabel = new Label();
            scoreLabel.Text = $"🎯 Overall Score: {result.Score:F1}% ({GetGradeLetter(result.Score)})";
            performanceBreakdown.AddChild(scoreLabel);

            // Time taken
            var timeLabel = new Label();
            timeLabel.Text = $"⏱️ Time Taken: {result.Duration.TotalMinutes:F1} minutes";
            ...
            difficultyLabel.Text = $"🎲 Questions Answered: {result.QuestionsAnswered}/{result.TotalQuestions}";
        ...
        private List<string> GenerateRecommendations(AssessmentResult result)
        {
            ...
            if (result.Score >= 90)
            {
                ...
                recommendations.Add("🎓 You're ready to help other students with this topic.");
            }
            else if (result.Score >= 70)
            {
                recommendations.Add("   Good progress! Focus on areas where you scored below 80%.");
                recommendations.Add("📚 Review the topics you found challenging.");
            }
            else if (result.Score >= 50)
            {
                recommendations.Add("     Consider reviewing the fundamental concepts.");
                recommendations.Add("🗣️ Have more conversations with the specialist.");
                recommendations.Add("🎯 Practice with easier assessments first.");
            }
            else
            {
                recommendations.Add("🌱 Start with basic concepts and build up gradually.");
                recommendations.Add("       Spend more time in conversation with the specialist.");
                recommendations.Add("📚 Use the learning resources provided.");
            }
